...
selectCountries.addEventListener('change', async function(e){
    ...
    activecase.innerHTML = 'Getting data⌛';
    newcase.innerHTML = 'Getting data⌛';
    recoveredcase.innerHTML = 'Getting data⌛';
    totalcases.innerHTML = 'Getting data⌛';
    totaldeaths.innerHTML = 'Getting data⌛';
    totaltests.innerHTML = 'Getting data⌛';
    populasi.innerHTML = 'Getting data⌛'
